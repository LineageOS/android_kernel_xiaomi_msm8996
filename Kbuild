...
#Enable Carplay Channel Switch
CONFIG_WLAN_CARPLAY_CHANNEL_SWITCH := 1
...
ifeq ($(CONFIG_WLAN_CARPLAY_CHANNEL_SWITCH), 1)
CDEFINES += -DFEATURE_WLAN_CARPLAY_CHANNEL_SWITCH
endif
